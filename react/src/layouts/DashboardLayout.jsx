    ...
    return (
        <>
            ...
            <div className="flex min-h-screen bg-gray-100">
                {/* Sidebar */}
                <div className={`sticky top-0 z-50 w-64 bg-gray-900 shadow-lg transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out md:relative md:translate-x-0 md:flex md:flex-col md:w-1/5`}>
