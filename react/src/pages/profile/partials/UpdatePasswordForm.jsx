            ...
            <form onSubmit={updatePassword} className="mt-6 space-y-6">
                <div>
                    ...
                    <input
                        ...
                        className="mt-1 block w-full lg:w-8/12 px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
